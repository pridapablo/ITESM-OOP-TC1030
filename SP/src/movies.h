...
public:
    ...
    void printInfo()
    {
        std::cout << "La película " << nombre << " con ID " << ID << " dura " << duracionMin << " es de genero " << genero << " y tiene calificación de " << calif << std::endl;
    }
};
...
public:
    ...
    void printInfo()
    {
        std::cout << "El episodio " << nomEpisodio << " de la serie " << nombre << " con ID " << ID << " dura " << duracionMin << " es de genero " << genero << " pertenece a la temporada " << temporada << " y tiene calificación de " << calif << std::endl;
    }
};